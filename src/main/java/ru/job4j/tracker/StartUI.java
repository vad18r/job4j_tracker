...
public class StartUI {
    ...
    public static void deleteItemById(Tracker tracker, Input input) {
    ...
    public static void findItemByName(Tracker tracker, Input input) {
    ...
    public void init(Input input, Tracker tracker) {
        ...
        while (run) {
            ...
            if (select == 0) {
                ...
                StartUI.deleteItemById(tracker, input);
            } else if (select == 4) {
